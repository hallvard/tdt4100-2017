...
public class ArrayListNimController extends Application {
	...
	private ArrayListNim nim;
	
	public void initialize() {
		nim = new ArrayListNim();
		update();
	}
	...
	private void update() {
		pile1.setText(Integer.toString(nim.getPileCount(0)));
		pile2.setText(Integer.toString(nim.getPileCount(1)));
		pile3.setText(Integer.toString(nim.getPileCount(2)));
	...
	public static void main(String[] args) {
		launch(ArrayListNimController.class, args);
	}
}
